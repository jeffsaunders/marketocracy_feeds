...
$custom = "2016/08/18%";
$today = date("Y/m/d")."%";
$sql = "SELECT * FROM `695_txt` WHERE `eventcd` LIKE 'BON' AND `changed` LIKE '$yesterday' AND `exchgcntry` LIKE 'US';";
...
print $csv;
$file_date =  date("Ymd");
$filename = "/var/www/html/EDI/BB_FEED/EDI-BB-BON_translate.cax.".$file_date;
