...
for ($counter=1; $counter <= mysqli_num_rows($result); $counter++)
        ...
        $csv .= $_695localcode.' US Equity|0|0|0|EDI'.$eventid.'_'.$eventcd.$date1.'|CHG_ID|'.$actflag.'|'.$_695issuername.'|CUSIP|'.$uscode.'|USD|Equity| |'.$created.'|'.$date1.'|'.$changed.'|N.A.|'.$bbgcompositeglobalid.'|'.$_695localcode.'|US|5|CP_OLD_CUSIP|'.$field4.'|CP_NEW_CUSIP|'.$field5.'|CP_OLD_ISIN|'.$field2.'|CP_NEW_ISIN|'.$field3.'|CP_NOTES|N.A.|  ' . "\r\n";
        }
//print "hi";
