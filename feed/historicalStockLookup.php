...
$pp_string = '_Token=EF2662FA141B4DC086F6A72B2D15AD2C&IdentifierType=Symbol&AdjustmentMethod=None&Identifiers='.$string.'&AsOfDate='.$AsOfDate;
$opts = array('http'=>
        array('method' =>'POST',
                'port' =>'443',
...
$file = fopen('http://www.xignite.com/xGlobalHistorical.json/GetGlobalHistoricalQuotes', 'rb', false, $context) or die ("Xignite API not responding");
