...
for ($counter=1; $counter <= mysqli_num_rows($result); $counter++)
        ...
        $csv .= $field2.' US Equity|0|0|0|EDI'.$eventid.'_'.$eventcd.$date1.'|CHG_TKR|'.$actflag.'|'.$_695issuername.'|CUSIP|'.$uscode.'|USD|Equity| |'.$created.'|'.$date1.'|'.$changed.'|N.A.|'.$bbgcompositeglobalid.'|'.$_695localcode.'|US|3|CP_OLD_TKR|'.$field2.' US|CP_NEW_TKR|'.$field3.' US|CP_NOTES|N.A.| ' . "\r\n";
        }
//print "hi";
