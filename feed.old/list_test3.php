...
//$array = array("XNYS", "XASE", "ARCX");
//$array = array("XNAS","XNYS", "XASE", "ARCX","XOTC");
$array = array("XNYS","XASE","XNYS" );
$total = 0;
foreach($array as $kkey => $exc)
    {
    print "######################".$exc."#############################";
    $pp_string = 'Exchange='.$exc.'&StartSymbol=A&EndSymbol=Z&_Token=EF2662FA141B4DC086F6A72B2D15AD2C';
    //$pp_string = 'Exchange='.$exc.'&_Token=EF2662FA141B4DC086F6A72B2D15AD2C';
    $opts = array('http'=>
            array('method' =>'POST',
                    'port' =>'443',
