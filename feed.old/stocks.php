...
$count_sql = "SELECT count(*) as count FROM `stock_valid_symbols2` WHERE `traded` = '1';";
$count_result = mysqli_query($mylink, $count_sql);
...
for ($loop=1; $loop <=$num_of_requests; $loop++)
    ...
    $symbol_sql = "SELECT * FROM `stock_valid_symbols2` WHERE `traded` = '1' LIMIT $step, $results_per_request;";
    //print $symbol_sql;
